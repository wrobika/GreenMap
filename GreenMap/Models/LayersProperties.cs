...
namespace GreenMap.Models
{
    public class LayersProperties
    {
        ...
        public static Dictionary<string, Layer> Layers = new Dictionary<string, Layer>
        {
            ...
            { "filter", new Layer{ FullName = "filtracja", Visible = false, Color = "Silver", Opacity = 1, Text="Black", Cluster=true, Radius=12} },
            ...
            { "rbdh", new Layer{ FullName = "baza otworów badawczych", Visible = true, Color = "DarkGoldenRod", Opacity = 1, Text="White", Cluster=true, Radius=11} },
            { "monitoring", new Layer{ FullName = "monitoring", Visible = false, Color = "Violet", Opacity = 1, Text="Black", Cluster=true, Radius = 10} },
