...
namespace GreenMap.Models
{
    public class LayersProperties
    {
        public static Dictionary<string, Layer> Layers = new Dictionary<string, Layer>
        {
            ...
            { "miasto", new Layer{ Color = "OrangeRed", Opacity = 0.7, Stroke="OrangeRed", Text="White"} },
            ...
            { "zwierciadło", new Layer{ Color = "DarkBlue", Opacity = 1, Text="White", Cluster=true, Radius=11} },
            { "obiekty", new Layer{ Color = "DarkGoldenRod", Opacity = 1, Text="White", Cluster=true, Radius=10} },
            { "odwierty", new Layer{ Color = "Red", Opacity = 1, Text="White", Cluster=true, Radius=9} },
        };
    }
}
